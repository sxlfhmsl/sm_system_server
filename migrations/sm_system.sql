...
ALTER TABLE `sm_user` ADD CONSTRAINT `FK_Reference_4` FOREIGN KEY (`RoleID`) REFERENCES `sm_user_role` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `sm_clerk` ADD CONSTRAINT `FK_Reference_5` FOREIGN KEY (`AgentID`) REFERENCES `sm_user_agent` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE `sm_user_member` ADD CONSTRAINT `FK_Reference_7` FOREIGN KEY (`AgentID`) REFERENCES `sm_user_agent` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `sm_buy_trade` ADD CONSTRAINT `FK_Reference_8` FOREIGN KEY (`MemberID`) REFERENCES `sm_user_member` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `sm_sell_trade` ADD CONSTRAINT `FK_Reference_9` FOREIGN KEY (`MemberID`) REFERENCES `sm_user_member` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE `sm_trade_bill` ADD CONSTRAINT `FK_Reference_10` FOREIGN KEY (`MemberID`) REFERENCES `sm_user_member` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE `sm_manual_trade` ADD CONSTRAINT `FK_Reference_14` FOREIGN KEY (`MemberID`) REFERENCES `sm_user_member` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `sm_manual_trade` ADD CONSTRAINT `FK_Reference_15` FOREIGN KEY (`CreatorID`) REFERENCES `sm_user_admin` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `sm_recharge` ADD CONSTRAINT `FK_Reference_16` FOREIGN KEY (`MemberID`) REFERENCES `sm_user_member` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `sm_agent_drawing` ADD CONSTRAINT `FK_Reference_17` FOREIGN KEY (`AgentID`) REFERENCES `sm_user_agent` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `sm_member_drawing` ADD CONSTRAINT `FK_Reference_18` FOREIGN KEY (`MemberID`) REFERENCES `sm_user_member` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
